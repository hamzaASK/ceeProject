  ...
  return (
    ...
    <div className={classes.root} >
      ...
      <Paper className={classes.paper} style={{background:'#f5f5f5'}}>
          ...
          <Typography  variant="h6" noWrap>{this.props.statistics.withImage}</Typography>
          <Typography variant="h6" noWrap>Sans Image</Typography>
          <Typography variant="h6" noWrap>{this.props.statistics.WithoutImage}</Typography>
        </Paper>
