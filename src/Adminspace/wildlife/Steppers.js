          ...
          <Grid container spacing={24} >
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                      ...
                      value={this.state.nomFR} onChange={this.handleChange('nomFR')}
              ...
              <Grid item xs={12}  >
                <TextField  id="outlined-simple-start-adornment"  variant="outlined" label="Le nom de la Faune"  style={{width:'100%'}}
                    value={this.state.nomAR} onChange={this.handleChange('nomAR')}
                    InputProps={{ startAdornment: <InputAdornment position="start"><ShortText style={{color:'#A2A2A5'}}/></InputAdornment>,}}/>
              </Grid>
              {/*******/}
              <Grid item xs={12}   >
              ...
              <Grid item xs={12}  >
              <TextField  id="outlined-simple-start-adornment"  variant="outlined" label="Le nom de la Faune"  style={{width:'100%'}}
                    value={this.state.nomeng} onChange={this.handleChange('nomeng')}
                    InputProps={{ startAdornment: <InputAdornment position="start"><ShortText style={{color:'#A2A2A5'}}/></InputAdornment>,}}/>
              </Grid>
              {/*******/}
              <Grid item xs={12}   >
              ...
              <Grid item xs={12}  >
                <TextField style={{width:'100%'}}
                    ...
                    value={this.state.statuts_conservation} onChange={this.handleChange('statuts_conservation')}
                    InputProps={{startAdornment: <InputAdornment position="start"><WbIridescent style={{color:'#A2A2A5'}}/></InputAdornment>,}}>
                    {ranges2.map(option => (<MenuItem key={option.value} value={option.label}>{option.label}</MenuItem>))}
                </TextField>
              </Grid>
            </Grid>
          </Grid>
              ...
              <Grid item xs={12}>
                  ...
                  <Grid item xs={12}>
                    <TextField multiline={true} rows={2} rowsMax={2} id="outlined-simple-start-adornment" className={classNames(classes.fullWidth, classes.textField)} 
                              value={this.state.infoAR} onChange={this.handleChange('infoAR')}
                  ...
                  <Grid item xs={12}>
                    <TextField multiline={true} rows={2} rowsMax={2}
                      ...
                      value={this.state.infoFR} onChange={this.handleChange('infoFR')}
                  ...
                  <Grid item xs={12}>
                    <TextField  multiline={true} rows={2} rowsMax={2} id="outlined-simple-start-adornment"className={classNames(classes.fullWidth, classes.textField)} 
                                value={this.state.infoeng} onChange={this.handleChange('infoeng')}
...
Upload = async () => {
  ...
  /****         Create Request          ****/
  let req = new Request('http://localhost:8080/ceedisplay/ceedisplay/src/Adminspace/php/uploadWildlife.php',
  {method: 'POST',headers: h,mode: 'no-cors',body: fd});
  ...
  axios.post('http://localhost:8000/api/ajouterfaune', 
              {
                nomAR:this.state.nomAR,
                nomFR:this.state.nomFR,
                nomeng:this.state.nomeng,
                infoAR:this.state.infoAR,
                infoeng:this.state.infoeng,
                infoFR:this.state.infoFR,
                image:this.state.image,
                statuts_conservation:this.state.statuts_conservation,
  ...
  ReactDOM.render(<div style={{width: '600px', marginTop: '0px',marginBottom: '2px',marginLeft:'auto',marginRight:'auto' }}> 
                    ...
                    <Divider variant="middle" />
                      <img alt='img' style={{borderRadius: '20px',width:'400px',display:'block',marginLeft:'auto',marginRight:'auto'}} className={classes.instructions} 
...
newPublicationHome=()=>{
  ...
  render() {
    ...
    return (
      <div style={{height:'100%'}}> <Button onClick={this.newPublicationHome.bind(this)}><ArrowBack /></Button>
