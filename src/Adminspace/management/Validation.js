          ...
          <Grid container spacing={24} >
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                      ...
                      error={this.state.error.titreAr} required helperText={this.state.helperText.titreAr}
              ...
              <Grid item xs={12}  >
                <TextField  id="outlined-simple-start-adornment"  variant="outlined" label="Le nom de la Faune"  style={{width:'100%'}}
                    ...
                    error={this.state.error.titreFR} required helperText={this.state.helperText.titreFR}
                    InputProps={{ startAdornment: <InputAdornment position="start"><ShortText style={{color:'#A2A2A5'}}/></InputAdornment>,}}/>
              </Grid>
              {/*******/}
              <Grid item xs={12}   >
              ...
              <TextField  id="outlined-simple-start-adornment"  variant="outlined" label="Le nom de la Faune"  style={{width:'100%'}}
                    ...
                    error={this.state.error.titreENG} required helperText={this.state.helperText.titreENG}
                    InputProps={{ startAdornment: <InputAdornment position="start"><ShortText style={{color:'#A2A2A5'}}/></InputAdornment>,}}/>
              </Grid>
            </Grid>
          </Grid>
              ...
              <Grid item xs={12}>
                  ...
                  <Grid item xs={12}>
                    <TextField multiline={true} rows={2} rowsMax={2} id="outlined-simple-start-adornment" className={classNames(classes.fullWidth, classes.textField)} 
                              ...
                              error={this.state.error.contenuAR} required helperText={this.state.helperText.contenuAR}
                  ...
                  <Grid item xs={12}>
                    <TextField multiline={true} rows={2} rowsMax={2}
                      ...
                      error={this.state.error.contenuFR} required helperText={this.state.helperText.contenuFR}
                  ...
                  <Grid item xs={12}>
                    <TextField  multiline={true} rows={2} rowsMax={2} id="outlined-simple-start-adornment"className={classNames(classes.fullWidth, classes.textField)} 
                                ...
                                error={this.state.error.contenuENG} required helperText={this.state.helperText.contenuENG}
...
handleChange = prop => event => {
  if (event.target.value.length > 0) {
    ...
    this.setState({ helperText:{[prop]:'Invalid format'}, error:{[prop]:true}
  });
  }
...
Upload = async () => 
{
  const { classes } = this.props;  
    ...
    axios.post('http://localhost:8000/api/post', 
                ...
                }).then(function (response) {console.error(response.data)}).catch(function (error){console.error(error)});
    ...
    ReactDOM.render(<div style={{width: '600px', marginTop: '0px',marginBottom: '2px',marginLeft:'auto',marginRight:'auto' }}> 
                      ...
                      <Divider variant="middle" />
                      <img alt='img' style={{borderRadius: '20px',width:'400px',display:'block',marginLeft:'auto',marginRight:'auto'}} className={classes.instructions} src={this.state.imageBase64} />
