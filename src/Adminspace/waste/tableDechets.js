...
class App extends Component
{
  ...
  state = {
    ...
    books: [],
    editBookData: { id: '', type: '', poids: '', niveau: '', date_creation: '', },
    newBookModal: false,
    editBookModal: false
  }
  /***************************************/
  ...
  updateBook ()
  {
    let { type, poids, niveau, date_creation, } = this.state.editBookData;
    axios.put( 'http://localhost:8000/api/updatedech/' + this.state.editBookData.id, { type, poids, niveau, date_creation } )
      .then( ( response ) =>
      {
        this._refreshBooks();
      } );
  ...
  deleteBook ( id )
  {
    axios.delete( 'http://localhost:8000/api/deletedechet/' + id ).then( ( response ) =>
    {
      this._refreshBooks();
    } );
  }
        ...
        <Modal isOpen={ this.state.editBookModal } toggle={ this.toggleEditBookModal.bind( this ) } >
          ...
          <ModalBody >
            ...
            <FormGroup>
              ...
              {
                let { editBookData } = this.state; editBookData.niveau = e.target.value;
                this.setState( { editBookData } );
              } }
...
const A7 = withStyles( styles )( App );
export default A7
