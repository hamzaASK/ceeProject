...
class HorizontalLinearStepper extends React.Component
{
  ...
  */
  Upload = async () =>
  {
    ...
    axios.post( 'http://localhost:8000/api/addRessource',
      {
    ...
    ReactDOM.render( <div style={ { width: '600px', marginTop: '0px', marginBottom: '2px', marginLeft: 'auto', marginRight: 'auto' } }>
      ...
      <Divider variant="middle" />
      <img alt='' style={ { borderRadius: '20px', width: '400px', display: 'block', marginLeft: 'auto', marginRight: 'auto' } } className={ classes.instructions }
