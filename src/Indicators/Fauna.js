                            ...
                            { this.state.books.map( tile => (
                                ...
                                <Grid container spacing={ 24 } align="center" justify="center" >
                                    <Grid item spacing={ 24 } style={ { padding: '10px', height: '50%', marginTop: '10px' } } >
                                        <img src={ tile.image === 'WithoutImage' || !tile.image ? 'images/flora/1.png' : "images/wildlife/" + tile.image } alt='kk' style={ { width: '750px', height: '375px', borderRadius: '20px' } } />
                                    </Grid>
